    ...
    <div class="row">
        <div class="col-md-9">
            ...
            <table class="table table-light table-bordered">
                <tbody>
                    <tr class="texr-center">
                        <td class="texr-center"  align="center"  colspan="4">Prestamo</td>
                    </tr>
                    <tr>
                        <th width='20%'>Monto Credito</th>
                        <th width='15%' class="texr-center">TI Anual</th>
                        <th width='20%' class="texr-center">Numero de Pagos</th>
            ...
            <table class="table table-light table-bordered">
                <tbody>
                <tr class="texr-center">
                        <td class="texr-center"  align="center"  colspan="4">Amortizacion</td>
                    </tr>
                    <tr>
                        <th width='40%'>Num. Pago</th>
                        <th width='15%' class="texr-center">Pago Interes</th>
