...
<nav id="menu" class="navbar navbar-default navbar-fixed-top">
  <div class="container"> 
    ...
    <div class="navbar-header">
      ...
      <img id="logo" src="{{asset('assets/img/logo1.png')}}"><a1>CrediFast</a1> </div>
      ...
      <div class="container">
        <div class="row">
          <div class="intro-text">
            ...
            <br><a href="{{ url('/simulador') }}" class="btn btn-custom btn-lg page-scroll">Simula tu Prestamo</a> </div>
        </div>
      </div>
    </div>
  </div>
    ...
    <div class="row">
      ...
      <div class="col-xs-12 col-md-6">
        <div class="about-text">
          <center><h2>Aprovecha al máximo tu casa, auto o nómina y ¡alcanza tus metas!</h2></center>
          <center><hr></center>
          ...
          <img id="icon" src="{{asset('assets/img/icon_doc.png')}}"><a3> Pre-aprobación en 24 horas hábiles.</a3>
          <br><br><img id="icon" src="{{asset('assets/img/icon_rel.png')}}"><a3> Plazos flexibles con menos intereses.</a3>
          <br><br><img id="icon" src="{{asset('assets/img/icon_user.png')}}"><a3> Asesoría personalizada.</a3>
        </div>
      </div>
    </div>
  </div>
    ...
    <div class="row">
      <div class="col-xs-12 col-sm-6">
        <div class="menu-section">
          ...
          <hr>
          <br><center><p>Inicia tu solicitud en línea, de manera rápida y segura.</p></center>
        </div>
      </div>
      <div class="col-xs-12 col-sm-6">
        <div class="menu-section">
          ...
          <hr>
          <br><center><p>Evaluamos tu perfil para crear una oferta personalizada.</p></center>
        </div>
      </div>
    </div>
      <center><div class="col-xs-12 col-sm-6"></div></center>
        <div class="menu-section">
          <h2 class="menu-section-title">¡Listo!</h2>
          <hr>
          <br><center><p>Obtén tu préstamo y pon en marcha ese gran proyecto.</p></center>
        </div>
      </div>
    </div>
  </div>
...
<details>
  <summary><h1>¿Cuál es el monto mínimo que puedo solicitar?</h1></summary>
    <div>
      <p>Puedes solicitar un Crédito en Efectivo a partir de $2,000 pesos.</p>
    </div>  
</details>
<details>
  <summary><h1>¿Qué documentos necesito para aplicar a un préstamo con garantía hipotecaria?</h1></summary>
    <div> 
...
<details>
  <summary><h1>Si estoy en buró de crédito ¿puedo aplicar a un préstamo con garantía hipotecaria?</h1></summary>
    <div> 
      <p>Sí, estar en buró de crédito no es factor determinante para decidir no otorgarte un préstamo.</p>
    </div>  
</details>
<details>
  <summary><h1>¿Qué tipo de inmuebles son aceptados?</h1></summary>
    <div> 
...
<details>
  <summary><h1>¿Qué pasa con mi inmueble en garantía?</h1></summary>
    <div> 
...
<details>
  <summary><h1>¿Puedo vender o transferir el inmueble que usé como garantía?</h1></summary>
    <div> 
